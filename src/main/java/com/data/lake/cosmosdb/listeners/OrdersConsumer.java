...
public class OrdersConsumer {
    ...
    public OrdersConsumer(CosmosRepository cosmosRepository,
                            @Qualifier("orders") CosmosContainer cosmosContainer) {
    ...
    public void consumeMessages(@Payload String messages, @Header(KafkaHeaders.RECEIVED_KEY) String keys) {
        ...
        cosmosRepository.saveIntoCosmos(messages, keys, cosmosContainer, TopicsConfig.ORDERS);
