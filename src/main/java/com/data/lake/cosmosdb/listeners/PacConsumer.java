...
@Service
@Slf4j
public class PacConsumer {

    private final CosmosRepository cosmosRepository;
    private final CosmosContainer cosmosContainer;

    public PacConsumer(CosmosRepository cosmosRepository,
                          @Qualifier("pac") CosmosContainer cosmosContainer) {
    ...
    public void consumeMessages(@Payload String messages, @Header(KafkaHeaders.RECEIVED_KEY) String keys) {
        ...
        cosmosRepository.saveIntoCosmos(messages, keys, cosmosContainer, TopicsConfig.PAC);
